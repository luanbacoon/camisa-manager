              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-700">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-slate-300">Cliente</th>
                    <th className="text-right py-3 px-4 font-medium text-slate-300">Valor</th>
                    <th className="text-right py-3 px-4 font-medium text-slate-300">Lucro</th>
                ...
                <tbody>
                  {sales.map((sale) => (
                    <tr key={sale.id} className="border-b border-slate-700 hover:bg-slate-700/50">
                      ...
                      <td className="py-3 px-4 text-right">R$ {sale.amount.toFixed(2)}</td>
                      <td className="py-3 px-4 text-right text-green-400">R$ {sale.profit.toFixed(2)}</td>
